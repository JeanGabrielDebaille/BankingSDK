...
namespace TestApp
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            generalBankSettings.TlsCertificate = new X509Certificate2("qwac.der", "bankingsdk");
            generalBankSettings.SigningCertificate = new X509Certificate2("qseal.der", "bankingsdk");
